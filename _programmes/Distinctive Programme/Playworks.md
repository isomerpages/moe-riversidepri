...
---
<br>
<img src="/images/playwork1.jpg" style="width:300px">
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;<div>
<p>
	<img src="/images/playwork10.jpg" style="width:400px">
</p>
...
&nbsp;<input type="checkbox" id="accordion3">
 <label for="accordion3"><h5 style="color:navy">Learning for Life Programme (LLP) PeerWorks </h5></label>
&nbsp;&nbsp;&nbsp;&nbsp;<div>
	
<p style="text-align: center; font-size: 20px;">Building Self, Supporting One Another, Serving the Community Together.</p>
	
<p>PeerWorks is one of Riverside Primary School’s Distinctive Programme, which aims to cultivate exemplary character traits and a service mindset in every Riverian, nurturing their empathy to serve their peers and community.
...
<br>
</p><p style="font-size: 20px;"><b>What is Riverside's PeerWorks?</b>
</p><p>Building on MOE’s Peer Support Framework, Riverside’s PeerWorks expands into the following three domains: </p>
<ul>
      <li>Peer Bonding</li>
      <li>Peer Helping</li>
      <li>Peer Influencing</li>
 </ul>
Figure 1.  MOE Peer Support Framework
<img src="/images/llp01.png" align="left" style="width:100%;">
<br>
<br>
<p style="font-size: 20px;"><b>What is our PeerWorks Model (Figure 2)?</b>
</p><p>There are two tiers of implementation of Peer Support Relationships: </p>
<ul>
      <li>Tier 1: Every student is a peer supporter</li>
      <li>Tier 2: Selected students as Peer Support Leaders (PSL) to lead, champion and advocate PSR efforts</li>
 </ul>
Figure 2.  Riverside's PeerWorks Model
<img src="/images/llp02.png" align="left" style="width:100%;">
<p style="font-size: 20px;"><b>Implementation of PeerWorks in Riverside</b>
	
Our school engages Riverians in PeerWorks through two tiers: In Tier 1, every Riverian is a Peer Supporter and is equipped with the following modules:
</p><ul>
      <li>Building Friendships and Connections</li>
      <li>Caring for One Another</li>
	    <li>Understanding and Supporting Others</li>
      <li>Being a Positive Influence</li>
    	<li>Leading with Compassion</li>
      <li>Serving the Community</li>
</ul>
In Tier 2, selected Riverians are given opportunities as Peer Support Leaders to provide support for their classmates and/or schoolmates as mentioned in MOE’s CHEER Model (Figure 3).
	
Figure 3.  Riverside's PeerWorks Model
<img src="/images/llp03.png" align="left" style="width:100%;">
